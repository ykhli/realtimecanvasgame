...
var spriteSheet = [ "images/sage2.png" , "images/firefox.png " ];
var currentHero = 0;
...
var render = function () {
	...
	ctx.textAlign = "left";
	ctx.textBaseline = "top";
	ctx.fillText("Heros position: " + hero.x + " : " + hero.y, 60, 60);
	...
	ctx.textAlign = "left";
	ctx.textBaseline = "top";
	ctx.fillText("map width and height: " + canvas.width + " : " + canvas.height, 90, 90);
